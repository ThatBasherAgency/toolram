...
const map = {
  ...
  "cps-test-1-segundo": dynamic(() => import("./cps-test").then((m) => { const C = m.CpsTest; const V = () => <C defaultSeconds={1} />; return V; }), { ssr: false }),
  "cps-test-5-segundos": dynamic(() => import("./cps-test").then((m) => { const C = m.CpsTest; const V = () => <C defaultSeconds={5} />; return V; }), { ssr: false }),
  "cps-test-10-segundos": dynamic(() => import("./cps-test").then((m) => { const C = m.CpsTest; const V = () => <C defaultSeconds={10} />; return V; }), { ssr: false }),
  "cps-test-30-segundos": dynamic(() => import("./cps-test").then((m) => { const C = m.CpsTest; const V = () => <C defaultSeconds={30} />; return V; }), { ssr: false }),
  "cps-test-60-segundos": dynamic(() => import("./cps-test").then((m) => { const C = m.CpsTest; const V = () => <C defaultSeconds={60} />; return V; }), { ssr: false }),
  "contador-de-clicks": dynamic(() => import("./click-counter").then((m) => m.ClickCounter), { ssr: false }),
  "contador-barra-espaciadora": dynamic(() => import("./spacebar-counter").then((m) => m.SpacebarCounter), { ssr: false }),
  "jitter-click-test": dynamic(() => import("./cps-test").then((m) => { const C = m.CpsTest; const V = () => <C defaultSeconds={10} />; return V; }), { ssr: false }),
  "butterfly-click-test": dynamic(() => import("./cps-test").then((m) => { const C = m.CpsTest; const V = () => <C defaultSeconds={10} />; return V; }), { ssr: false }),
  "drag-click-test": dynamic(() => import("./cps-test").then((m) => { const C = m.CpsTest; const V = () => <C defaultSeconds={10} />; return V; }), { ssr: false }),
