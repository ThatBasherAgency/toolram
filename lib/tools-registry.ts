...
export const CATEGORIES: Record<ToolCategory, { name: string; slug: string; description: string; emoji: string }> = {
  ...
  finance: { name: "Finanzas", slug: "finanzas", description: "Interés compuesto, préstamos, sueldos, inversión.", emoji: "💵" },
  design: { name: "Diseño", slug: "diseno", description: "CSS, gradientes, paletas, contraste, aspect ratio.", emoji: "🎨" },
  marketing: { name: "Marketing", slug: "marketing", description: "ROI, CTR, CPC, CPM, ROAS, captions, SEO copy.", emoji: "📈" },
  network: { name: "Redes", slug: "redes", description: "Subnet CIDR, MAC, DNS, WHOIS, headers.", emoji: "🌐" }
};
...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    related: ["cps-test-10-segundos", "jitter-click-test", "cps-test-1-segundo", "butterfly-click-test"]
  },
  {
    slug: "cps-test-1-segundo",
    category: "test",
    name: "CPS Test 1 segundo",
    shortDesc: "Mide tu pico máximo de clicks en 1 segundo (burst).",
    longDesc:
      "El test de 1 segundo mide tu pico de velocidad (burst): cuántos clicks logras en el instante más rápido, sin que entre en juego la resistencia. Es el formato preferido para medir spikes en PvP y para comparar técnicas explosivas como el drag o el butterfly clicking. Como la ventana es mínima, los resultados son más altos y variables que en 5 o 10 segundos. 100% en tu navegador, sin registro.",
    keywords: ["cps test 1 segundo", "1 second cps test", "test de clicks 1 segundo", "burst click test", "pico cps"],
    popularity: 90,
    faqs: [
      { q: "¿Qué mide el test de 1 segundo?", a: "Tu pico de velocidad (burst): el máximo de clicks que consigues en el instante más rápido, sin desgaste por resistencia. Por eso los números son más altos que en tests largos." },
      { q: "¿Cuántos clicks en 1 segundo es bueno?", a: "Más de 10 clicks en 1 segundo es muy bueno; con técnicas como drag o butterfly se ven picos de 14-20+ en esa ventana." },
      { q: "¿Por qué mi CPS de 1s es más alto que el de 10s?", a: "Porque en 1 segundo no entra la fatiga muscular. La velocidad sostenida (5-10s) siempre es menor que el pico instantáneo." },
      { q: "¿Sirve el test de 1 segundo para Minecraft PvP?", a: "Para medir tu burst sí, pero en combate real importa más la velocidad sostenida de 5-10s. Usa el de 1s para ver tu techo." }
    ],
    related: ["cps-test", "cps-test-5-segundos", "cps-test-10-segundos", "drag-click-test"]
  },
  {
    slug: "cps-test-5-segundos",
    category: "test",
    name: "CPS Test 5 segundos",
    shortDesc: "Test de 5 segundos: el estándar competitivo de Minecraft PvP.",
    longDesc:
      "El test de 5 segundos equilibra burst y resistencia: es la duración estándar en la comunidad competitiva de Minecraft PvP porque refleja la velocidad real que puedes mantener en un intercambio de golpes. Suficientemente corto para exigir velocidad alta, pero lo bastante largo para que la técnica y la consistencia importen. 100% en tu navegador, gratis y sin registro.",
    keywords: ["cps test 5 segundos", "5 second click test", "test de clicks 5 segundos", "cps minecraft pvp", "click speed 5s"],
    popularity: 91,
    faqs: [
      { q: "¿Por qué 5 segundos es el estándar en PvP?", a: "Porque refleja la velocidad que de verdad puedes mantener durante un intercambio de golpes en Minecraft, mejor que el pico de 1 segundo." },
      { q: "¿Qué CPS es bueno en 5 segundos?", a: "6-8 CPS es promedio, 8-10 es buen jugador y más de 10-12 sostenidos en 5s ya es nivel competitivo." },
      { q: "¿Es mejor entrenar con 5 o 10 segundos?", a: "Empieza con 5s para ganar velocidad y pasa a 10s para construir resistencia. Combinar ambos es lo ideal." },
      { q: "¿Cómo subo mi CPS en 5 segundos?", a: "Relaja la mano, apoya el codo, usa un mouse con switches ligeros y practica intervalos cortos. La tensión te frena." }
    ],
    related: ["cps-test", "cps-test-1-segundo", "cps-test-10-segundos", "jitter-click-test"]
  },
  {
    slug: "cps-test-10-segundos",
    category: "test",
    name: "CPS Test 10 segundos (Kohi)",
    shortDesc: "El benchmark mundial: test de 10 segundos, conocido como Kohi.",
    longDesc:
      "El test de 10 segundos es el benchmark más usado del mundo para comparar CPS entre jugadores; se popularizó como 'Kohi click test' por el servidor Kohi de Minecraft. Mide velocidad sostenida: requiere mantener la cadencia sin que la fatiga la baje. Es el número que la mayoría reporta cuando dice 'mi CPS', así que es el ideal para compararte con otros. 100% en tu navegador, sin registro.",
    keywords: ["cps test 10 segundos", "kohi click test", "10 second click test", "test de clicks 10 segundos", "cps sostenido"],
    popularity: 95,
    faqs: [
      { q: "¿Qué es el Kohi click test?", a: "Es el nombre popular del test de 10 segundos, originado en el servidor Kohi de Minecraft. Se convirtió en el estándar de facto para comparar CPS entre jugadores." },
      { q: "¿Qué CPS es bueno en 10 segundos?", a: "El promedio humano sostenido es 6-8 CPS; un buen jugador hace 8-10; mantener más de 12 CPS durante 10 segundos completos es excepcional." },
      { q: "¿Por qué el test de 10s es el estándar?", a: "Porque mide velocidad sostenida real, no un pico puntual, y es lo bastante largo para que la técnica y la resistencia decidan el resultado." },
      { q: "¿Cómo mejorar mi CPS de 10 segundos?", a: "Trabaja resistencia: empieza rápido pero dosifica, relaja la mano, hidrata las palmas y practica a diario tests de 10s completos." }
    ],
    related: ["cps-test", "cps-test-5-segundos", "cps-test-60-segundos", "jitter-click-test"]
  },
  {
    slug: "cps-test-60-segundos",
    category: "test",
    name: "CPS Test 60 segundos",
    shortDesc: "Test de resistencia: mantén tu velocidad de click durante 1 minuto.",
    longDesc:
      "El test de 60 segundos mide resistencia y consistencia: cuánto puedes mantener tu velocidad de click durante un minuto entero antes de que la fatiga muscular la baje. Es el más exigente físicamente y el mejor para detectar si tu técnica es sostenible o si te quemas pronto. Útil para entrenar stamina de mano y para pruebas de durabilidad de mouse. 100% en tu navegador, gratis.",
    keywords: ["cps test 60 segundos", "60 second cps test", "test de clicks 1 minuto", "resistencia click", "stamina cps"],
    popularity: 85,
    faqs: [
      { q: "¿Qué mide el test de 60 segundos?", a: "Resistencia y consistencia: cuánto aguantas tu velocidad de click durante un minuto completo antes de que la fatiga la reduzca." },
      { q: "¿Es normal que mi CPS baje en 60 segundos?", a: "Sí, es esperable. El reto del test de 1 minuto es minimizar esa caída con buena técnica y mano relajada." },
      { q: "¿Para qué sirve el test de 1 minuto?", a: "Para entrenar stamina de mano, comprobar si tu técnica es sostenible y hacer pruebas de durabilidad del mouse." },
      { q: "¿Cómo mantener el CPS durante 60 segundos?", a: "No salgas a tope desde el inicio: marca un ritmo sostenible, relaja el antebrazo y respira. La constancia gana al sprint." }
    ],
  ...
  },
  {
    ...
    shortDesc: "Mide tu velocidad con la técnica de jitter clicking.",
    longDesc:
      "El jitter click test mide tu CPS usando la técnica de jitter clicking: tensar el antebrazo y la muñeca para hacerlos vibrar y disparar clicks muy rápido, alcanzando picos de hasta ~14 CPS. Es una de las técnicas favoritas en Minecraft PvP por su velocidad, pero cansa rápido y, mal ejecutada o en exceso, puede causar fatiga o lesión por esfuerzo repetitivo (RSI). Practícala en sesiones cortas. 100% en tu navegador.",
    keywords: ["jitter click test", "jitter clicking", "test jitter click", "como hacer jitter click", "cps jitter"],
    popularity: 88,
    faqs: [
      { q: "¿Qué es el jitter clicking?", a: "Una técnica que consiste en tensar y vibrar el brazo/muñeca para disparar clicks a alta frecuencia, alcanzando hasta ~14 CPS." },
      { q: "¿Cómo se hace jitter click?", a: "Apoya el antebrazo, ténsalo ligeramente y deja que la vibración muscular controlada pulse el botón. Requiere práctica para mantener la puntería." },
      { q: "¿El jitter clicking es malo para la mano?", a: "En exceso puede causar fatiga, dolor o lesión por esfuerzo repetitivo (RSI). Limita las sesiones a 15-20 minutos y descansa." },
      { q: "¿Cuántos CPS se logran con jitter?", a: "Con práctica se alcanzan picos de 10-14 CPS, bastante por encima del clicking normal (6-8 CPS)." },
      { q: "¿El jitter clicking está permitido en Minecraft?", a: "El jitter es generalmente aceptado (es manual), a diferencia de los autoclickers. Aun así, revisa las reglas del servidor." }
    ],
    related: ["cps-test", "butterfly-click-test", "drag-click-test", "cps-test-10-segundos"]
  },
  {
    slug: "butterfly-click-test",
    category: "test",
    name: "Butterfly Click Test",
    shortDesc: "Mide tu CPS con la técnica de butterfly clicking (dos dedos).",
    longDesc:
      "El butterfly click test mide tu velocidad usando butterfly clicking: alternar dos dedos sobre el mismo botón del mouse para casi duplicar la cadencia, llegando a 14-16 CPS con el ratón adecuado. Es muy rápido, pero algunos servidores de Minecraft lo restringen por considerarlo demasiado cercano al autoclick (genera dobles registros). Comprueba aquí cuántos CPS consigues con esta técnica. 100% en tu navegador, sin registro.",
    keywords: ["butterfly click test", "butterfly clicking", "test butterfly click", "como hacer butterfly click", "cps butterfly"],
    popularity: 86,
    faqs: [
      { q: "¿Qué es el butterfly clicking?", a: "Una técnica que alterna dos dedos sobre el mismo botón del mouse para casi duplicar la cadencia de clicks, alcanzando 14-16 CPS." },
      { q: "¿Cómo se hace butterfly click?", a: "Coloca dos dedos sobre el botón y altérnalos rápidamente, manteniendo un ritmo constante. Funciona mejor con mouse de switches rápidos." },
      { q: "¿Está prohibido el butterfly clicking?", a: "Algunos servidores de Minecraft lo restringen porque puede generar dobles registros parecidos al autoclick. Revisa las reglas antes de usarlo en PvP." },
      { q: "¿Butterfly o jitter, cuál es más rápido?", a: "El butterfly suele dar más CPS sostenido (14-16) y cansa menos que el jitter, pero depende mucho del mouse y de tu técnica." }
    ],
    related: ["cps-test", "jitter-click-test", "drag-click-test", "cps-test-10-segundos"]
  },
  {
    slug: "drag-click-test",
    category: "test",
    name: "Drag Click Test",
    shortDesc: "Mide picos extremos de CPS con la técnica de drag clicking.",
    longDesc:
      "El drag click test mide tu velocidad usando drag clicking: arrastrar el dedo por el botón aprovechando la fricción para que registre muchos clicks de golpe, con picos de 20+ CPS. Depende muchísimo del mouse (necesita una superficie y switches específicos) y suele estar prohibido en PvP competitivo por dar una ventaja artificial. Prueba aquí cuántos clicks consigues arrastrando. 100% en tu navegador.",
    keywords: ["drag click test", "drag clicking", "test drag click", "como hacer drag click", "cps drag"],
    popularity: 84,
    faqs: [
      { q: "¿Qué es el drag clicking?", a: "Una técnica que arrastra el dedo por el botón del mouse aprovechando la fricción para registrar muchos clicks de golpe, con picos de 20+ CPS." },
      { q: "¿Qué mouse sirve para drag click?", a: "Necesitas un mouse con switches y acabado de botón que generen suficiente fricción; no todos lo permiten. Por eso los resultados varían tanto." },
      { q: "¿El drag clicking está permitido?", a: "Suele estar prohibido en servidores de Minecraft competitivos porque da una ventaja artificial y desgasta el mouse. Úsalo solo para probar tu pico." },
      { q: "¿Es malo para el mouse?", a: "Sí, el drag clicking acelera el desgaste de los switches y del recubrimiento del botón. Hazlo con moderación." }
    ],
    related: ["cps-test", "jitter-click-test", "butterfly-click-test", "cps-test-1-segundo"]
  },
  {
  ...
  { slug: "calculadoras-marketing", category: "marketing", name: "Calculadoras de Marketing Digital", shortDesc: "ROI · CTR · CPC · CPM · ROAS · Conversión · 6 métricas en 1 tool.", longDesc: "Suite de 6 calculadoras esenciales de marketing digital y performance: ROI (Return on Investment), CTR (Click Through Rate), CPC (Cost Per Click), CPM (Cost Per Mille), ROAS (Return On Ad Spend) y tasa de conversión. Con benchmarks por industria y feedback automático sobre la salud de tu campaña.", keywords: ["calculadora roi", "calcular ctr", "calcular cpc", "roas calculator", "metricas marketing"], popularity: 96, related: ["generador-utm", "anchor-text", "creador-backlinks"] },
  { slug: "conversor-zonas-horarias", category: "converter", name: "Conversor de Zonas Horarias", shortDesc: "Hora exacta en LATAM, España, USA, Asia · Comparación lado a lado.", longDesc: "Conversor de zonas horarias en tiempo real para 19 ciudades clave (CDMX, Buenos Aires, Santiago, Lima, Bogotá, Caracas, São Paulo, Madrid, Londres, París, NYC, LA, Tokio, Shanghái, Dubái, Sídney, UTC). Comparación lado a lado para coordinar reuniones internacionales remotas. Soporta hora actual o conversión de fecha específica.", keywords: ["conversor zona horaria", "diferencia horaria", "world clock", "hora mundial"], popularity: 93, related: ["dias-entre-fechas", "conversor-duracion", "calculadora-edad"] },
  { slug: "dias-entre-fechas", category: "calculator", name: "Calculadora Días Entre Dos Fechas", shortDesc: "Días, semanas, meses, años entre 2 fechas · Modo días laborables.", longDesc: "Calcula la diferencia exacta entre dos fechas en días, semanas, meses, años, horas, minutos, segundos. Modo opcional 'solo días laborables' que excluye sábados y domingos. Útil para antigüedad laboral, deadlines, vencimientos, embarazo, viajes y cualquier cálculo temporal preciso.", keywords: ["dias entre fechas", "diferencia entre fechas", "calculadora fechas", "days between dates"], popularity: 92, related: ["calculadora-edad", "calculadora-embarazo", "dias-laborables"] },
  { slug: "wifi-qr", category: "generator", name: "Generador QR para WiFi", shortDesc: "Tus invitados se conectan al WiFi con un QR · Sin tipear pass.", longDesc: "Generador de código QR para conectarse al WiFi automáticamente. Compatible con iOS y Android (cámara nativa de iPhone, Google Lens). Soporta WPA/WPA2, WEP y redes abiertas. Opción de red oculta. Imprimí el QR y pegalo en tu casa, oficina, Airbnb, café, restaurante. Tus invitados ya no tipean contraseñas largas.", keywords: ["qr wifi", "wifi qr generator", "qr para wifi", "compartir wifi qr"], popularity: 95, related: ["generador-qr", "escaner-qr", "whatsapp-link"] },
  { slug: "css-flex-generator", category: "design", name: "CSS Flexbox Generator Visual", shortDesc: "Editor visual de Flexbox · Cambia valores y ve el resultado.", longDesc: "Generador visual de CSS Flexbox para aprender y crear layouts en segundos. Controlá flex-direction, justify-content, align-items, flex-wrap y gap mientras ves el preview en tiempo real. Copia el CSS final con un click. Incluye explicación visual de cada propiedad.", keywords: ["css flexbox generator", "flex visual", "generador flex", "aprender flexbox"], popularity: 91, related: ["css-grid-generator", "cubic-bezier-generator", "clip-path-generator"] },
  { slug: "css-grid-generator", category: "design", name: "CSS Grid Generator", shortDesc: "Generador visual de CSS Grid · Templates auto-fit/fill.", longDesc: "Editor visual de CSS Grid Layout. Define columnas y filas con sintaxis fr, px, % o auto-fit/auto-fill con minmax. 6 presets profesionales (sidebar, holy grail, masonry-style). Preview en vivo y código copiable. Construí grids responsivos sin pelearte con la sintaxis.", keywords: ["css grid generator", "grid visual", "css grid layout", "auto-fit minmax"], popularity: 90, related: ["css-flex-generator", "cubic-bezier-generator", "aspect-ratio-calculator"] },
  { slug: "cubic-bezier-generator", category: "design", name: "Cubic Bezier Generator", shortDesc: "Curvas de animación CSS · Visualización gráfica + preview.", longDesc: "Generador visual de cubic-bezier() para CSS animations y transitions. Editá los 4 puntos de control viendo la curva resultante en gráfico SVG. 10 presets profesionales (ease, linear, bounce, swift, in-back, out-back). Preview con bola animada para sentir el timing. Para animaciones más naturales que ease-in-out.", keywords: ["cubic bezier generator", "css easing", "animation curve", "transition timing"], popularity: 88, related: ["css-flex-generator", "css-grid-generator", "clip-path-generator"] },
  { slug: "clip-path-generator", category: "design", name: "CSS Clip-Path Generator", shortDesc: "12 formas listas · Estrella, corazón, hexágono, onda, flecha.", longDesc: "Generador de clip-path con 12 formas pre-hechas: triángulo, rombo, pentágono, hexágono, estrella, corazón, flecha, bocadillo de chat, círculo, elipse, diagonal, onda. Personalizá el color y copiá el CSS. Sin SVG, sin máscaras complejas, animable con CSS transitions.", keywords: ["css clip-path", "clip path generator", "shape divider", "css shapes"], popularity: 86, related: ["css-grid-generator", "gradient-generator", "box-shadow-generator"] },
  { slug: "aspect-ratio-calculator", category: "design", name: "Calculadora de Aspect Ratio", shortDesc: "Relación de aspecto · Calcula dimensiones manteniendo proporción.", longDesc: "Calculadora de relación de aspecto (aspect ratio) para imágenes, videos y elementos web. Ingresá ancho y alto, obtené el ratio simplificado (16:9, 4:3, 1:1, etc) y un decimal. Calculá nuevas dimensiones manteniendo la proporción exacta. Presets para Instagram, TikTok, YouTube, Pinterest.", keywords: ["aspect ratio calculator", "calcular relacion aspecto", "ratio imagen", "dimension proporcional"], popularity: 87, related: ["redimensionar-imagen", "youtube-thumbnail", "css-grid-generator"] },
  { slug: "contraste-color-wcag", category: "design", name: "Verificador de Contraste WCAG", shortDesc: "Accesibilidad de colores · WCAG AA y AAA · Score en tiempo real.", longDesc: "Verificador de contraste de color según estándares WCAG 2.1 (AA y AAA). Ingresá color de texto y fondo, obtené el ratio exacto y si cumple los 5 niveles: texto normal AA/AAA, texto grande AA/AAA, UI/iconos. Preview en vivo del texto sobre el fondo elegido. Crucial para accesibilidad legal en gobiernos y empresas grandes.", keywords: ["contraste color wcag", "accesibilidad colores", "wcag aa aaa", "contrast checker"], popularity: 89, related: ["paleta-colores", "convertidor-color", "rgb-cmyk"] },
  { slug: "markdown-table-generator", category: "developer", name: "Generador de Tabla Markdown", shortDesc: "Editá la tabla visualmente y copiá el Markdown formateado.", longDesc: "Generador de tablas Markdown con editor visual. Agregá/quitá filas y columnas, escribí el contenido en celdas. Soporta alineación por columna (izq, centro, der). Ideal para README de GitHub, blog posts en Markdown, notas Notion, docs técnicas.", keywords: ["markdown table", "tabla markdown", "github table", "md table generator"], popularity: 85, related: ["markdown-html", "html-table-generator", "css-formatter"] },
  { slug: "mock-data-generator", category: "developer", name: "Generador de Datos de Prueba", shortDesc: "Mock data realista LATAM · JSON, CSV o SQL.", longDesc: "Generador de datos de prueba (mock data) realistas con nombres, apellidos, emails, teléfonos, direcciones y empresas LATAM. Output en JSON (con comentarios), CSV (separado por comas) o SQL (INSERT INTO). 1 a 100 registros. Para poblar bases de datos de testing, mockups con datos creíbles, presentaciones.", keywords: ["mock data generator", "datos de prueba", "fake data spanish", "test data generator"], popularity: 87, related: ["generador-nombres", "json-csv", "validador-email"] },
  { slug: "subnet-calculator", category: "network", name: "Calculadora de Subred CIDR", shortDesc: "Subneteo IPv4 · Network, broadcast, máscara, hosts.", longDesc: "Calculadora de subred CIDR (Classless Inter-Domain Routing) para IPv4. Calculá dirección de red, broadcast, máscara de subred, wildcard, primer y último host utilizables, y total de IPs según el prefix /1 a /32. Útil para administradores de red, ingenieros DevOps, certificaciones Cisco/CompTIA.", keywords: ["subnet calculator", "calculadora subred", "cidr calculator", "ip subnet"], popularity: 84, related: ["mac-address-generator", "dns-lookup", "headers-checker"] },
  { slug: "texto-binario-converter", category: "converter", name: "Convertidor Texto ↔ Binario", shortDesc: "Codificá texto en binario UTF-8 · Y de vuelta a texto.", longDesc: "Convertidor bidireccional de texto a binario y de binario a texto. Cada caracter ASCII se representa con 8 bits (1 byte). Para Unicode/UTF-8 usa 1-4 bytes por caracter. Útil para entender computación a bajo nivel, juegos de hackers, mensajes secretos.", keywords: ["texto a binario", "binario a texto", "binary text converter", "ascii binary"], popularity: 83, related: ["binario-decimal", "hash-md5-sha", "base64-encode"] },
  { slug: "rgb-cmyk-converter", category: "design", name: "Conversor RGB · HEX · CMYK · HSL", shortDesc: "Para diseñadores web e impresión · CMYK profesional.", longDesc: "Conversor entre los 4 modelos de color más usados: HEX (web), RGB (pantallas), CMYK (impresión offset), HSL (manipulación intuitiva). Visualización del color con picker. Click para copiar cada formato. CMYK es para impresión profesional — los monitores muestran RGB. Esencial para gráfica para imprenta, packaging, branding.", keywords: ["rgb a cmyk", "convertidor color", "cmyk converter", "hsl color"], popularity: 88, related: ["paleta-colores", "convertidor-color", "contraste-color-wcag"] },
  { slug: "salario-hora-anual", category: "finance", name: "Conversor Salario Hora ↔ Anual", shortDesc: "Convertir tarifa por hora a sueldo anual y viceversa.", longDesc: "Conversor entre tarifa por hora y sueldo anual considerando horas por semana (10-60) y semanas por año (40-52). Muestra equivalentes diario, semanal, mensual y anual. Útil para freelancers comparando ofertas, empleados evaluando si dejar el trabajo full-time, negociaciones de sueldo.", keywords: ["salario por hora a anual", "convertir sueldo", "hourly to annual", "calcular tarifa freelance"], popularity: 90, related: ["calculadora-sueldo-neto", "calculadora-horas-trabajadas", "calculadora-prestamo"] },
  { slug: "mac-address-generator", category: "network", name: "Generador de Direcciones MAC", shortDesc: "MACs aleatorias para tests · VMs · Vendor opcional.", longDesc: "Generador de direcciones MAC aleatorias en formato XX:XX:XX:XX:XX:XX, XX-XX-XX-XX-XX-XX o Cisco AAAA.BBBB.CCCC. Vendor prefix opcional para Google, VMware, VirtualBox, Xen, QEMU/KVM o Locally Administered. Útil para configurar VMs, testear firewalls, generar pseudo-identidades de red.", keywords: ["mac address generator", "generador mac", "fake mac", "vm mac address"], popularity: 81, related: ["subnet-calculator", "dns-lookup", "generador-uuid"] },
  { slug: "generador-keywords-seo", category: "seo", name: "Generador de Palabras Clave SEO", shortDesc: "+40 variaciones por intent · Comercial, info, comparativa.", longDesc: "Generador de keywords SEO basado en intent: comercial (mejor X, comprar X, X precio), informacional (qué es X, cómo funciona X), comparativa (X vs Y, alternativas a X), local (X cerca de mí, X en CDMX), long-tail (X paso a paso, X para principiantes) y preguntas (cuánto cuesta X, dónde comprar X). Más de 40 variaciones por palabra raíz.", keywords: ["generador keywords", "ideas keywords seo", "keyword research", "long tail keywords"], popularity: 92, related: ["densidad-keywords", "anchor-text", "generador-titulos-seo"] },
  { slug: "subject-line-tester", category: "marketing", name: "Tester de Asunto de Email", shortDesc: "Score de tu subject line · Detecta palabras spam.", longDesc: "Analiza el asunto de tu email marketing y devuelve un score 0-100 considerando: longitud (30-60 chars ideal), palabras spam (gratis, 100%, $$$, etc), power words (nuevo, exclusivo, secreto), uso de emoji, números, mayúsculas excesivas, signos !. Útil para mejorar open rate antes de mandar campañas en Mailchimp, Sendgrid, Brevo.", keywords: ["subject line tester", "asunto email", "tester email marketing", "open rate email"], popularity: 89, related: ["firma-email", "validador-email", "calculadoras-marketing"] },
  { slug: "generador-descripcion-producto", category: "marketing", name: "Generador de Descripción de Producto", shortDesc: "4 estilos · Beneficios, storytelling, bullets, lifestyle.", longDesc: "Generador de descripciones de producto en 4 estilos persuasivos: beneficios+features, storytelling emocional, bullets concisos y lifestyle/aspiracional. Para tiendas online (Shopify, Mercado Libre, WooCommerce, Tienda Nube, Amazon). Convertís features fríos en copy que vende.", keywords: ["descripcion producto", "product description", "copy ecommerce", "shopify descripcion"], popularity: 91, related: ["subject-line-tester", "tagline-generator", "caption-generator"] },
  { slug: "generador-nombre-empresa", category: "generator", name: "Generador de Nombres de Empresa", shortDesc: "Naming creativo para startups · 6 estilos.", longDesc: "Generador de nombres para empresas, startups y marcas en 6 estilos: compuesto inglés (NeoTech), marca+sufijo (toolHub), mash-up (NeoLumi), espaciado (Solo Box), sufijos -ify/-ly (Toolify), prefijo+espacio (Pro Vela). 30 ideas por click. Verificá disponibilidad de .com y handles de redes antes de elegir.", keywords: ["generador nombre empresa", "naming startup", "business name generator", "nombres marca"], popularity: 88, related: ["tagline-generator", "favicon-generator", "generador-logo-texto"] },
  { slug: "tagline-generator", category: "marketing", name: "Generador de Slogan / Tagline", shortDesc: "12 fórmulas de slogan probadas.", longDesc: "Generador de taglines/slogans usando 12 fórmulas probadas en branding (compuesto, comparativo, beneficio directo, command, lifestyle). Ingresá tu marca + promesa principal y obtené 12 variaciones. Para campañas, perfiles sociales, signatures de email, slogans publicitarios.", keywords: ["generador slogan", "tagline generator", "frase publicitaria", "lema marca"], popularity: 86, related: ["generador-nombre-empresa", "generador-descripcion-producto", "caption-generator"] },
  { slug: "caption-generator", category: "ai", name: "Generador de Captions Redes Sociales", shortDesc: "Captions para IG, TikTok, LinkedIn, Twitter · Hooks + CTAs.", longDesc: "Generador de captions optimizados para 4 plataformas: Instagram (con hashtags y CTA bio), TikTok (formato corto + #fyp), LinkedIn (estilo profesional con bullet thread) y Twitter/X (formato thread). Incluye hooks atrapantes, preguntas de engagement y CTAs.", keywords: ["caption generator", "captions instagram", "tiktok caption", "captions sociales"], popularity: 92, related: ["generador-bio-instagram", "generador-hashtags", "youtube-tags-generator"] },
  { slug: "youtube-tags-generator", category: "seo", name: "Generador de Tags para YouTube", shortDesc: "Tags optimizados para SEO de video · Hasta 500 chars.", longDesc: "Generador de tags para YouTube optimizados para el algoritmo. Ingresá tu keyword principal y obtené 25+ variaciones long-tail (palabra + tutorial, español, 2026, paso a paso, etc). Copy directo separado por comas para pegar en YouTube Studio. Respeta el límite de 500 caracteres.", keywords: ["youtube tags generator", "etiquetas youtube", "youtube seo tags", "tags video"], popularity: 90, related: ["youtube-thumbnail", "generador-hashtags", "generador-titulos-seo"] },
  { slug: "conversor-duracion", category: "converter", name: "Conversor de Duración Tiempo", shortDesc: "ms ↔ s ↔ min ↔ h ↔ días ↔ semanas ↔ meses ↔ años.", longDesc: "Conversor entre todas las unidades de tiempo: milisegundos, segundos, minutos, horas, días, semanas, meses (promedio 30.44 días) y años (365.25 días). Output legible automático ('1h 30m' en vez de '5400s'). Útil para programadores, científicos, planificación de proyectos.", keywords: ["conversor tiempo", "duration converter", "convertir minutos a horas", "segundos a dias"], popularity: 88, related: ["dias-entre-fechas", "calculadora-edad", "conversor-zonas-horarias"] },
  { slug: "dias-laborables", category: "calculator", name: "Calculadora de Días Laborables", shortDesc: "Suma o resta días hábiles a una fecha · Sin fines de semana.", longDesc: "Calcula la fecha resultante después de sumar o restar N días laborables (lunes a viernes, opcional incluir sábados). Ignora fines de semana automáticamente. Para deadlines de proyectos, plazos legales, vencimientos administrativos. NOTA: no incluye feriados nacionales — sumá buffer si los hay.", keywords: ["dias laborables", "calculadora dias habiles", "business days calculator", "deadline calculator"], popularity: 86, related: ["dias-entre-fechas", "calculadora-edad", "calculadora-horas-trabajadas"] },
