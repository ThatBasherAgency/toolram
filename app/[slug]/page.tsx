...
export default async function ToolPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const SELF_HERO_TOOLS = new Set(["whois-domain", "dns-lookup", "headers-checker", "seo-quick-audit", "mi-ip", "generador-utm", "conversor-divisas", "numero-a-letras", "calculadora-edad", "htaccess-generator", "generador-hashtags", "password-strength", "calculadora-imc", "calculadora-porcentaje", "calculadora-prestamo", "calculadora-iva", "calculadora-propina", "calculadora-descuento", "box-shadow-generator", "gradient-generator", "paleta-colores", "numeros-romanos", "binario-decimal", "pomodoro", "calculadora-cientifica", "markdown-html", "favicon-generator", "creador-backlinks", "test-velocidad-web", "citas-apa", "buscar-rimas", "generador-username", "slug-generator", "youtube-thumbnail", "json-csv", "html-formatter", "js-formatter", "validador-email", "texto-a-voz", "voz-a-texto", "rotar-imagen", "filtros-imagen", "generador-nombres", "generador-anagrama", "generador-logo-texto", "anchor-text", "whatsapp-link", "ocr-imagen-texto", "calculadora-calorias", "calculadora-embarazo", "calculadora-ovulacion", "calculadora-horas-trabajadas", "validador-rfc-curp", "validador-clabe-cbu", "calculadora-sueldo-neto", "calculadora-edad-mascota", "escaner-qr", "barcode-generator", "buscador-emojis", "generador-bio-instagram", "firma-email", "validador-dni-nie", "interes-compuesto", "calculadoras-marketing", "conversor-zonas-horarias", "dias-entre-fechas", "wifi-qr", "css-flex-generator", "css-grid-generator", "cubic-bezier-generator", "clip-path-generator", "aspect-ratio-calculator", "contraste-color-wcag", "markdown-table-generator", "mock-data-generator", "subnet-calculator", "texto-binario-converter", "rgb-cmyk-converter", "salario-hora-anual", "mac-address-generator", "generador-keywords-seo", "subject-line-tester", "generador-descripcion-producto", "generador-nombre-empresa", "tagline-generator", "caption-generator", "youtube-tags-generator", "conversor-duracion", "dias-laborables", "html-table-generator", "ascii-art-generator", "cuenta-regresiva", "frecuencia-palabras"]);
